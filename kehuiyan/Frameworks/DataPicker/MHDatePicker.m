...
// _selectDate = [[NSDate date] dateByAddingTimeInterval:60*60];
        ...
        _pickerView.datePicker.datePickerMode = UIDatePickerModeDate;//UIDatePickerModeDateAndTime;
...
{
    if (isBeforeTime) {
        [_pickerView.datePicker setMinimumDate:[self dateFromString:@"1960-01-01"]];
