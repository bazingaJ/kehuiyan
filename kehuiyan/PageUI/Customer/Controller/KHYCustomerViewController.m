...
- (void)createUI
{
    ...
    bottomButton.frame = CGRectMake(0, SCREEN_HEIGHT - NAVIGATION_BAR_HEIGHT - HOME_INDICATOR_HEIGHT - 50, SCREEN_WIDTH, 50);
    [bottomButton setTitle:@"查看他人客户信息" forState:UIControlStateNormal];
    [bottomButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    bottomButton.titleLabel.font = FONT16;
    [bottomButton setBackgroundColor:MAIN_COLOR];
    [bottomButton addTarget:self action:@selector(lookCustomerBtnClick) forControlEvents:UIControlEventTouchUpInside];
...
- (NSArray *)rightButtons
{
    ...
    if ([self.isMine isEqualToString:@"2"]) {
        return nil;
    }
