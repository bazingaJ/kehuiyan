...
@implementation KHYHomeLeftTopView
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if(self) {
        ...
        UIImageView *imgView = [[UIImageView alloc] initWithFrame:CGRectMake((frame.size.width-70)/2, 50, 70, 70)];
        ...
        //创建“名称”
        UILabel *lbMsg = [[UILabel alloc] initWithFrame:CGRectMake(10, 130, frame.size.width-20, 20)];
        ...
        //创建“部门-角色”
        UILabel *lbMsg2 = [[UILabel alloc] initWithFrame:CGRectMake(10, 150, frame.size.width-20, 30)];
