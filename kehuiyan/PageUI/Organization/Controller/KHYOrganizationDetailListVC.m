...
@interface KHYOrganizationDetailListVC ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong) NSArray *dataArr;
@property (nonatomic, strong) NSMutableDictionary *sectionHeaderViewStatusDict;
@end
// 设置区头高度
static const CGFloat headerViewHeigh = 50;
@implementation KHYOrganizationDetailListVC
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        // 存在子部门 展开列表展示信息
        KHYOrganizationDetailVC *detailVC = [[KHYOrganizationDetailVC alloc] init];
