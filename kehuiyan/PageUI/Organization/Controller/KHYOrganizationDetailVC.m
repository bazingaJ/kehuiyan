...
- (void)initialized
{
    ...
    NSDictionary *dic = [NSDictionary changeType:self.dataDict];
    self.tableView.tableFooterView = [UIView new];
    [self.headImageView sd_setImageWithURL:[NSURL URLWithString:dic[@"avatar"]] placeholderImage:[UIImage imageNamed:@"default_img_round_list"]];
    self.realNameLab.text = dic[@"realname"];
    self.jobLab.text = dic[@"position"];
    self.officeName = @[@"电话",@"邮箱",@"微信"];
    
    self.detailName = @[[NSString getRightStringByCurrentString:dic[@"mobile"]],[NSString getRightStringByCurrentString:dic[@"email"]],[NSString getRightStringByCurrentString:dic[@"weixin"]]];
