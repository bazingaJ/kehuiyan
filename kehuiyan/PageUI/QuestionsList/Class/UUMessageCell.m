...
- (void)setMessageFrame:(UUMessageFrame *)messageFrame
{
    ...
    UIImage *normal;
    if (message.from == UUMessageFromMe) {
        normal = [UIImage uu_imageWithName:@"chat_fromMe"];
        normal = [normal resizableImageWithCapInsets:UIEdgeInsetsMake(22, 10, 10, 40)];
    }
    else{
        normal = [UIImage uu_imageWithName:@"chat_fromOther"];
        normal = [normal resizableImageWithCapInsets:UIEdgeInsetsMake(22, 40, 10, 10)];
    }
