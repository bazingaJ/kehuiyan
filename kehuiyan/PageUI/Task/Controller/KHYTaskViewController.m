...
- (void)createUI
{
    ...
    [bottomButton setTitle:@"查看他人任务信息" forState:UIControlStateNormal];
    [bottomButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    bottomButton.titleLabel.font = FONT16;
    [bottomButton setBackgroundColor:MAIN_COLOR];
    [bottomButton addTarget:self action:@selector(lookOtherBtnClick) forControlEvents:UIControlEventTouchUpInside];
